...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="When used with --generate-next-sweep, immediately execute the generated sweep spec.",
    )
...
def main() -> int:
    ...
    if args.generate_next_sweep:
        iteration = pipeline.iterate_next_sweep(
            ...
            execute=args.execute_generated_sweep,
        )
        ...
        print("[sweep] executed generated next-round training sweep")
        print(f"  spec: {proposal.output_path}")
        ...
        return 1 if int(result.summary.get("failed_variant_count", 0) or 0) > 0 else 0
