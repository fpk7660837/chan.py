...
- `README.md`：主入口，说明当前分支实际提供什么能力
- `docs/usage.md`：当前分支的使用文档
- `docs/autoresearch.md`：AutoResearch 专题文档
- `quick_guide.md`：底层 `CChan` / 缠论元素 / 自定义数据源说明

如果你主要想看底层缠论框架怎么用，继续看这份 `quick_guide.md` 即可。
